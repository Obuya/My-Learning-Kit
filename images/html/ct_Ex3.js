...
function equation() {
   //precondition: 
   //	num1,num2, and num3 are real numbers and are valid numbers for a quadratic equation

   //Postcondition:
   //	the roots of the quadratic is outputted                                
   ...
   var x1 = ((-b +  Math.sqrt((Math.pow(b,2)) - 4 * a * c))/ (2*a)).toFixed(2);
   var x2 = ((-b -  Math.sqrt((Math.pow(b,2)) - 4 * a * c))/ (2*a)).toFixed(2);
   ...
   */
   ...
   document.getElementById("output").innerHTML = "One root: " + x1 + "<br>" + "another: " + x2;
}