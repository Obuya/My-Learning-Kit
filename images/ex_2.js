...
function area() {
   //precondition: 
   //	num1 represents a Real number  greater than 0 but less than 100 
   // num2 represents a Real number  greater than 0 but less than 100
   // num3 represents a Real number  greater than 0 but less than 100

   //Postcondition:
   //	The area of the triangle abc is outputted                         
